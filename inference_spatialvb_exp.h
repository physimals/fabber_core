...
This version contains 'experimental' priors, which have been removed from the 
main implementation
...
class SpatialVariationalBayesExp : public VariationalBayesInferenceTechnique
{
public:
